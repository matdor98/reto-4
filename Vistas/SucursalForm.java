...
public class SucursalForm extends javax.swing.JDialog {
    ...
    public void recibeDatosDireccion(int idDireccion){
        ...
        if(sucursal.isEmpty()){
             JOptionPane.showMessageDialog(this,"Por favor ingresar el nombre de la sucursal");
        } else {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtSucursal, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
